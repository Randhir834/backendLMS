-- Restore instructor_registrations table
-- This table is needed for instructor application submissions
...
-- Add comment
COMMENT ON TABLE instructor_registrations IS 'Stores instructor registration applications';
