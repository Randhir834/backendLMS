...
const { getLiveClasses, getLiveClassById, createLiveClassController, updateLiveClass, deleteLiveClass, getFilterOptions, getCoursesWithLiveClasses } = require('../controllers/liveClassController');

const router = express.Router();

router.get('/', authenticate, getLiveClasses);
router.get('/courses', authenticate, getCoursesWithLiveClasses);
router.get('/filter-options', authenticate, authorizeRoles('admin'), getFilterOptions);
